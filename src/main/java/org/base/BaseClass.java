...
public class BaseClass {
	...
	public static  void selectbyvisibletext(WebElement s2,String text) {
	...
	public static void screenshot(String projectname) throws IOException {
		TakesScreenshot tk=(TakesScreenshot)driver;
		File src = tk.getScreenshotAs(OutputType.FILE);
		File des=new File("C:\\Users\\MANI MADDY\\eclipse-workspace\\CucumberBelltelme\\Screenshot\\"+projectname+".png");
